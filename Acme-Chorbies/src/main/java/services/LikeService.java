...
public class LikeService {
	...
	public Like reconstruct(LikeForm likeForm, BindingResult binding) {
		Assert.notNull(likeForm);
		Like result;
		Chorbi author;
		Chorbi receiver;
		
		author = this.chorbiService.findByPrincipal();
		receiver = this.chorbiService.findOne(likeForm.getIdReceiver());
